...
private:
    ...
    static LRESULT CALLBACK CustomButtonProc(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam, UINT_PTR subclassId, DWORD_PTR refData);
    ...
    inline static std::wstring m_tickerText = L"  ***  CATUPDATE SOFTWARE CENTER  ***  WITHOUT ADMIN OR SUDO  ***  EVOLVED WITH 1000:1 READABILITY-FIRST METHODOLOGY  ***  CYBERPUNK RETRO DEMOSCENE TRON EDITION  ***  STAY NATIVE, STAY COMPILED!  ***  ";
